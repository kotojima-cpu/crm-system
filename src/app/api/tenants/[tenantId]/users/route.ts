 ...
 * POST /api/tenants/[tenantId]/users — テナントユーザー直接作成
 */
...
import { listTenantUsers, createTenantUser, validateCreateTenantUserInput } from "@/features/tenant-users";
...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    return runInContext(async () => {
      ...
      const input = validateCreateTenantUserInput(body);
